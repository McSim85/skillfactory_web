...
has_dupes = {}
for event in events:
#    print(event["detectedDuplicate"])
    if event["detectedDuplicate"] == True:
        has_dupes[event["eventType"]] = "Has_dup"
...
sum_items = sum(event["item_price"] for event in events)
print(sum_items)


pege = [event["pageViewId"] for event in events if event["firstInSession"] == True]
print(pege)
